...
def get_test_pods(
    pod_name: str, pod_label: str, namespace: str, kubecli: KrknKubernetes, exclude_label: str = None
) -> typing.List[str]:
    """
    ...
    """
    pods_list = []
    pods_list = kubecli.list_pods(label_selector=pod_label, namespace=namespace, exclude_label=exclude_label)
...
def pod_outage(
    ...
    try:
        ...
        pods_list = get_test_pods(
            test_pod_name, test_label_selector, test_namespace, kubecli, params.exclude_label
        )
