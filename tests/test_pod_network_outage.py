...
from krkn.scenario_plugins.native.pod_network_outage.kubernetes_functions import list_pods
from krkn.scenario_plugins.native.pod_network_outage.pod_network_outage_plugin import get_test_pods
...
class TestPodNetworkOutage(unittest.TestCase):
    ...
    def test_get_test_pods_with_pod_name_and_exclude_label(self):
        ...
        result = get_test_pods("pod1", "app=test", "test-namespace", mock_kubecli, "skip=true")
